...
<div class="tdare">
  <table width="100%" cellspacing="0" class="dataTable">
    ...
    <?php if ($this->_var['enable_radar']): ?><td width="10%">商品雷达</td><?php endif; ?>
      ...
      <td class="table-center"><span ectype="order_by" fieldname="mall_recommended2">商城推荐2</span></td>
      <td class="table-center"><span ectype="order_by" fieldname="mall_sort_order">商城排序</span></td>
      ...
      <td class="table-center"><span ectype="order_by" fieldname="closed">禁售</span></td>
        <td class="table-center"><span ectype="order_by" fieldname="isnew">新品推荐</span></td>
      <td class="table-center"><span ectype="order_by" fieldname="isday">每日精选</span></td>
      <td class="table-center"><span ectype="order_by" fieldname="islike">猜你喜欢</span></td>
...
?>
    ...
    <?php endif; ?>
      ...
      <td class="table-center"><?php if ($this->_var['goods']['mall_recommended2']): ?><img src="templates/style/images/positive_enabled.gif" ectype="inline_edit" fieldname="mall_recommended2" fieldid="<?php echo $this->_var['goods']['goods_id']; ?>" fieldvalue="1" title="可编辑"/><?php else: ?><img src="templates/style/images/positive_disabled.gif" ectype="inline_edit" fieldname="mall_recommended2" fieldid="<?php echo $this->_var['goods']['goods_id']; ?>" fieldvalue="0" title="可编辑"/><?php endif; ?></td>
      <td class="table-center"><span ectype="inline_edit" fieldname="mall_sort_order" fieldid="<?php echo $this->_var['goods']['goods_id']; ?>" required="1" class="editable" title="可编辑"><?php echo htmlspecialchars($this->_var['goods']['mall_sort_order']); ?></span></td>
      ...
      <td class="table-center"><?php if ($this->_var['goods']['closed']): ?><img src="<?php echo $this->res_base . "/" . 'style/images/negative_enabled.gif'; ?>" ectype="inline_edit" fieldname="closed" fieldid="<?php echo $this->_var['goods']['goods_id']; ?>" fieldvalue="1" title="可编辑"/><?php else: ?><img src="<?php echo $this->res_base . "/" . 'style/images/negative_disabled.gif'; ?>" ectype="inline_edit" fieldname="closed" fieldid="<?php echo $this->_var['goods']['goods_id']; ?>" fieldvalue="0" title="可编辑"/><?php endif; ?></td>
        <td class="table-center"><?php if ($this->_var['goods']['isnew']): ?><img src="templates/style/images/positive_enabled.gif" ectype="inline_edit" fieldname="isnew" fieldid="<?php echo $this->_var['goods']['goods_id']; ?>" fieldvalue="1" title="可编辑"/><?php else: ?><img src="templates/style/images/positive_disabled.gif" ectype="inline_edit" fieldname="isnew" fieldid="<?php echo $this->_var['goods']['goods_id']; ?>" fieldvalue="0" title="可编辑"/><?php endif; ?></td>
      <td class="table-center"><?php if ($this->_var['goods']['isday']): ?><img src="templates/style/images/positive_enabled.gif" ectype="inline_edit" fieldname="isday" fieldid="<?php echo $this->_var['goods']['goods_id']; ?>" fieldvalue="1" title="可编辑"/><?php else: ?><img src="templates/style/images/positive_disabled.gif" ectype="inline_edit" fieldname="isday" fieldid="<?php echo $this->_var['goods']['goods_id']; ?>" fieldvalue="0" title="可编辑"/><?php endif; ?></td>
      <td class="table-center"><?php if ($this->_var['goods']['islike']): ?><img src="templates/style/images/positive_enabled.gif" ectype="inline_edit" fieldname="islike" fieldid="<?php echo $this->_var['goods']['goods_id']; ?>" fieldvalue="1" title="可编辑"/><?php else: ?><img src="templates/style/images/positive_disabled.gif" ectype="inline_edit" fieldname="islike" fieldid="<?php echo $this->_var['goods']['goods_id']; ?>" fieldvalue="0" title="可编辑"/><?php endif; ?></td>
