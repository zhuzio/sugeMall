...
?>
        ...
        <li><a class="<?php if ($_GET['app'] == 'store' && $_GET['act'] == 'coupon'): ?>active<?php else: ?>normal<?php endif; ?>" href="<?php echo url('app=store&act=coupon&id=' . $this->_var['store']['store_id']. ''); ?>"><span>优惠卷</span></a></li>
