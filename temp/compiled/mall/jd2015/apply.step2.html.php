      ...
      <form method="post" enctype="multipart/form-data" id="apply_form">
         <table>
           ...
           <tr>
             ...
             <tr>
                 <th>店铺类型：</th>
                 <td><input type="radio" checked class="input border" name="o2o" value="online" />线上 <input type="radio" class="input border" name="o2o" value="offline" />线下</td>
                 <td class="padding3"> <span class="field_notice">请选择店铺类型</span></td>
             </tr>
           <tr>
              <th>所属分类：</th>
              <td>
           ...
           <tr>
              ...
              <td>
                  <div class="select_add" id="region" style="width:500px;">
                      ...
                      <input type="hidden" name="province" id="province" value="<?php echo $this->_var['user']['province']; ?>" class="" />
                      <input type="hidden" name="city" id="city" value="<?php echo $this->_var['user']['city']; ?>" class="" />
                      <input type="hidden" name="area" id="area" value="<?php echo $this->_var['user']['area']; ?>" class="" />
