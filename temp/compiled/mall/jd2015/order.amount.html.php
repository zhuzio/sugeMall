...
<div class="w price-promotion mt10 mb10 f60">
    ...
    <p class="allow-coupon border padding10 mb10 hidden clearfix">
        <span class="note">
            当前用户可用积分<em style="font-weight:bold;color:red;padding: 0 5px;"><?php echo $this->_var['member_integral']; ?></em>,
            本次订单最多可使用积分<em style="font-weight:bold;color:red;padding: 0 5px;"><?php echo $this->_var['total_integral_max_exchange']; ?></em>
            积分比例为<em style="font-weight:bold;color:red;padding: 0 5px;"><?php echo ($this->_var['integral_seller'] == '') ? '0' : $this->_var['integral_seller']; ?></em>
        </span>
