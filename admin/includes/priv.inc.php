...
(
    ...
    (
        ...
        'deposit' => 'deposit|all',//提现记录
        'payment_log' => 'payment_log|all',//支付记录
		'sgxt_order' => 'sgxt_order|all',//积分订单
        'commission' => 'commission|all',//佣金记录
        'profit' => 'profit|all',//收益记录
        'order_offline' => 'order_offline|all',//线下订单
    ),
    'website' => array
    (
    ...
    (
        ...
        'integral_goods'   => 'integral_goods|all',//兑换产品管理
        'integral_goods_log'   => 'integral_goods_log|all',//兑换产品记录
    ),
    'external' => array
    (
