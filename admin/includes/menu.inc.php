...
return array(
    ...
    'user' => array(
        ...
        'children' => array(
            ...
            'user_req' => array(
                'text' => '升级请求',
                'url' => 'index.php?app=user&act=req',
            ),
            'admin_manage' => array(
    ...
    'trade' => array(
        ...
        'children' => array(
            ...
            'order_offline' => array(
                'text' => '线下订单',
                'url' => 'index.php?app=order_offline'
            ),
            /*'payment_log' => array(
                'text' => '积分订单',
                'url' => 'index.php?app=payment_log',
            ),*/
			'sgxt_order' => array(
                'text' => '积分订单',
                'url' => 'index.php?app=sgxt_order',
            ),
            'deposit' => array(
                'text' => '提现申请',
            ...
            'balance' => array(
                'text' => '购物积分赠送记录',
                'url' => 'index.php?app=balance',
            ),
            'profit' => array(
                'text' => '市场收益奖励记录',
                'url' => 'index.php?app=profit',
            ),
            'subsidy' => array(
                'text' => '市场补贴消费积分',
                'url' => 'index.php?app=subsidy',
            ),
    ...
    'wap_setting' => array(
        ...
        'children' => array(
			...
			'cate_ad' => array(
                'text' => Lang::get('cate_ad'),
                'url' => 'index.php?app=cate_ad',
            ),
            'waptheme' => array(
