...
class MyException extends Exception{
           ...
           public function showerror($model){
               $model->show_warning('sss');
           }
           public function addLog($file){
                logAdd($this->message,$file);
           }
    }
...
function logAdd($word='',$test = 'log.txt') {
        $fp = fopen($test,"a");
        flock($fp, LOCK_EX) ;
