...
class jd2015_floor1Widget extends BaseWidget {

    var $_name = 'jd2015_floor1';
    var $_ttl = 86400;
    var $_num = 6;
    ...
    function _get_data() {
        ...
        $data = array(
            ...
            'sub_title_name5_link_url' => $this->options['sub_title_name5_link_url'],
            'sub_title_name6' => $this->options['sub_title_name6'],
            'sub_title_name6_link_url' => $this->options['sub_title_name6_link_url'],
