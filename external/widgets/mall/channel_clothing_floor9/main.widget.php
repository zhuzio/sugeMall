...
class channel_clothing_floor9Widget extends BaseWidget {

    var $_name = 'channel_clothing_floor9';
    var $_ttl = 86400;
    var $_num = 4;
    ...
    function _get_data() {
        $data = array(
            ...
            'cates_3' => $this->get_cate($this->options['cate_id_3']),
            'cates_4' => $this->get_cate($this->options['cate_id_4']),
            ...
            'subtitle3_name' => $this->options['subtitle3_name'],
            'subtitle4_name' => $this->options['subtitle4_name'],
