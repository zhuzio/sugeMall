...
class channel_phone_floor4Widget extends BaseWidget {

    var $_name = 'channel_phone_floor4';
    var $_ttl = 86400;
    var $_num = 10;
   function _get_data() {
            ...
            $data = array(
                ...
                'goods_list_2' => $recom_mod->get_recommended_goods($this->options['img_recom_id_2'], 6, true, $this->options['img_cate_id_2']),
            );
             return $data;
        }
