...
class StoreModel extends BaseModel
{
     ...
     * @return  string  图片文件名
     */
    function compute_credit_bak($credit_value, $step = 5)
    {
        $level_1 = $step * 5;
        $level_2 = $level_1 * 6;
        $level_3 = $level_2 * 6;
...
//        }
        else
        {
            ...
            $credit = 'heart_1.gif';
            switch ($credit_value) {
                case $credit_value>=intval(Conf::get('s_level_1_from'))&&$credit_value<intval(Conf::get('s_level_1_to')):
                    $credit = 'heart_1.gif';
                    break;
                case $credit_value>=intval(Conf::get('s_level_2_from'))&&$credit_value<intval(Conf::get('s_level_2_to')):
                    $credit = 'heart_2.gif';
                    break;
                case $credit_value>=intval(Conf::get('s_level_3_from'))&&$credit_value<intval(Conf::get('s_level_3_to')):
                    $credit = 'heart_3.gif';
                    break;
                case $credit_value>=intval(Conf::get('s_level_4_from'))&&$credit_value<intval(Conf::get('s_level_4_to')):
                    $credit = 'heart_4.gif';
                    break;
                case $credit_value>=intval(Conf::get('s_level_5_from'))&&$credit_value<intval(Conf::get('s_level_5_to')):
                    $credit = 'heart_5.gif';
                    break;
                case $credit_value>=intval(Conf::get('s_level_6_from'))&&$credit_value<intval(Conf::get('s_level_6_to')):
                    $credit = 'diamond_1.gif';
                    break;
                case $credit_value>=intval(Conf::get('s_level_7_from'))&&$credit_value<intval(Conf::get('s_level_7_to')):
                    $credit = 'diamond_2.gif';
                    break;
                case $credit_value>=intval(Conf::get('s_level_8_from'))&&$credit_value<intval(Conf::get('s_level_8_to')):
                    $credit = 'diamond_3.gif';
                    break;
                case $credit_value>=intval(Conf::get('s_level_9_from'))&&$credit_value<intval(Conf::get('s_level_9_to')):
                    $credit = 'diamond_4.gif';
                    break;
                case $credit_value>=intval(Conf::get('s_level_10_from'))&&$credit_value<intval(Conf::get('s_level_10_to')):
                    $credit = 'diamond_5.gif';
                    break;
                case $credit_value>=intval(Conf::get('s_level_11_from'))&&$credit_value<intval(Conf::get('s_level_11_to')):
                    $credit = 'crown_1.gif';
                    break;
                case $credit_value>=intval(Conf::get('s_level_12_from'))&&$credit_value<intval(Conf::get('s_level_12_to')):
                    $credit = 'crown_2.gif';
                    break;
                case $credit_value>=intval(Conf::get('s_level_13_from'))&&$credit_value<intval(Conf::get('s_level_13_to')):
                    $credit = 'crown_3.gif';
                    break;
                case $credit_value>=intval(Conf::get('s_level_14_from'))&&$credit_value<intval(Conf::get('s_level_14_to')):
                    $credit = 'crown_4.gif';
                    break;
                case $credit_value>=intval(Conf::get('s_level_15_from'))&&$credit_value<intval(Conf::get('s_level_15_to')):
                    $credit = 'crown_5.gif';
                    break;
                default:
                    break;
