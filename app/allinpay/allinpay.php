...
function getOrderinfo($dingdan){
    ...
    global $key;
    global $merchantId;
	global $goods_pickupUrl;
    global $point_pickupUrl;
	//第一位为0 默认为积分订单
	if($dingdan[0] == 'P'){
		...
		$order['pickupUrl']=$point_pickupUrl;
	}else{
		//商品订单支付
        ...
        $order['pickupUrl']=$goods_pickupUrl;
	}
	//查询有无通联的id
...
<body onLoad="javascript:document.ALLINPAY_FORM.submit()">
<form name="ALLINPAY_FORM" action="<?php echo $serverUrl ?>" method="post">
