...
//                    'complete' => 1,
    ...
    function czfs() {
        if ($_POST) {
            ...
            $log_text = $this->visitor->get('user_name') . $bank_name .' 支付 ' . $cz_money . Lang::get('yuan');
            ...
            switch ($czfs) {
                ...
                case 'llpay':                    
                    ?>
                    <body onLoad="javascript:document.WXNATIVE_FORM.submit()">
                    <form method="post" name="WXNATIVE_FORM" action="app/webllpay/llpayapi.php">
                        <input type="hidden" name="user_id" value="<?php echo $user_id; ?>">
                        <input type="hidden" name="user_name" value="<?php echo $user_name; ?>">
                        <input type="hidden" name="dingdan" value="<?php echo $dingdan; ?>">
                        <input type="hidden" name="cz_money" value="<?php echo $cz_money; ?>">
                ...
                case 'reapal':
                    ?>
                    <body onLoad="javascript:document.WXNATIVE_FORM.submit()">
                    <form method="post" name="WXNATIVE_FORM" action="app/reapal/rongpayto.php">
                        <input type="hidden" name="user_id" value="<?php echo $user_id; ?>">
                        <input type="hidden" name="user_name" value="<?php echo $user_name; ?>">
                        <input type="hidden" name="dingdan" value="<?php echo $dingdan; ?>">
                        <input type="hidden" name="cz_money" value="<?php echo $cz_money; ?>">
                ...
                case 'allinpay':
                    ?>
                    <body onLoad="javascript:document.WXNATIVE_FORM.submit()">
                    <form method="post" name="WXNATIVE_FORM" action="app/allinpay/allinpay_pc.php">
                        <input type="hidden" name="user_id" value="<?php echo $user_id; ?>">
                        <input type="hidden" name="user_name" value="<?php echo $user_name; ?>">
                        <input type="hidden" name="dingdan" value="<?php echo $dingdan; ?>">
                        <input type="hidden" name="cz_money" value="<?php echo $cz_money; ?>">
                ...
                case 'wapllpay':
                    ?>
                    <body onLoad="javascript:document.WXNATIVE_FORM.submit()">
                    <form method="post" name="WXNATIVE_FORM" action="app/wapllpay/llpayapi.php">
                        <input type="hidden" name="user_id" value="<?php echo $user_id; ?>">
                        <input type="hidden" name="user_name" value="<?php echo $user_name; ?>">
                        <input type="hidden" name="dingdan" value="<?php echo $dingdan; ?>">
                        <input type="hidden" name="cz_money" value="<?php echo $cz_money; ?>">
