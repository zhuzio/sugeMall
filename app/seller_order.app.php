...
class Seller_orderApp extends StoreadminbaseApp {
    ...
    function shipped() {
        ...
        if (!IS_POST) {
            ...
            $edit_data['auto_finished_time'] = time()+$auto_finished_day*3600*24;
            $edit_data['ship_time'] = time();
            $is_edit = true;
    ...
    function _get_orders() {
        ...
        foreach ($orders as $key1 => $order) {
            foreach ($order['order_goods'] as $key2 => $goods) {
                ...
                $orders[$key1]['order_goods'][$key2]['goods_image'] = QINIU_URL.$goods['goods_image'];
            }
            // psmb
