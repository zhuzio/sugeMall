...
class StoreApp extends StorebaseApp
{
    ...
    function _get_recommended_goods($id, $num = 12)
    {
        ...
        $goods_list = $goods_mod->find(array(
            ...
            'fields'     => 'goods_name, default_image, price,point',
            'limit'      => $num,
        ));
        ...
        foreach ($goods_list as $key => $goods)
        {
            ...
            $goods_list[$key]['default_image'] = QINIU_URL.$goods_list[$key]['default_image'];
        }
    ...
    function _get_new_groupbuy($id, $num = 12)
    {
        ...
        $groupbuy_list = $model_groupbuy->find(array(
            'fields'    => 'goods.default_image, this.group_name, this.group_id,this.spec_price,point,this.end_time',
            'join'      => 'belong_goods',
        ...
        foreach ($groupbuy_list as $key => $_g)
        {
            ...
            $groupbuy_list[$key]['price'] = $tmp['price'];
            $groupbuy_list[$key]['lefttime'] = lefttime($_g['end_time']);
            $groupbuy_list[$key]['default_image'] = QINIU_URL.$groupbuy_list[$key]['default_image'];
        }
	...
	function _get_hot_sale_goods($id, $num = 16)
	{
        ...
        $goods_list = $goods_mod->find(array(
            ...
            'fields'     => 'goods_name, default_image, price,point,sales',
    ...
    function _assign_searched_goods($id)
    {
        ...
        {
            empty($goods['default_image']) && $goods_list[$key]['default_image'] = Conf::get('default_goods_image');
            $goods_list[$key]['default_image'] =$goods_list[$key]['default_image'];
        }
