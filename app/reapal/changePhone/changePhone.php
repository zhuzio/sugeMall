...
<html>
  ...
  <body>
    <div align="center">
    <form action="changePhoneResult.php" method="post">
    <table align="center">
    	<tr><td colspan="2" align="center"><h2>更换手机号接口 </h2></td></tr>
		...
		<tr><td>绑卡ID</td><td><input type="text" name="bind_id" value=""/></td></tr>
